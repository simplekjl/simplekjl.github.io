...
<head>
    ...
    <meta name="description" content="Jose Luis Crisostomo Resume Online">
    <meta name="author" content="Xiaoying Riley at 3rd Wave Media">    
    <link rel="shortcut icon" href="prom.ico">  
...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <img class="profile-image img-responsive pull-left" src="assets/images/profile.png" alt="Jose Luis Crisostomo" />
            <div class="profile-content pull-left">
                <h1 class="name">Jose Luis Crisostomo</h1>
                <h2 class="desc">Android Developer</h2>   
                <ul class="social list-inline">
                    <li><a href="http://twitter.com/simpleck"><i class="fa fa-twitter"></i></a></li>    
            ...
            <div class="primary col-md-8 col-sm-12 col-xs-12">
                <section class="about section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p>Profesional Experience </p>
                            <ul type="square">
                                <li>4+ Years of experience in Android design and development</li>
                                <li>3+ Years of experience in websites development, including HTML5, CSS3, PHP and Apache</li>
                                <li>Working knowledge of Java, PHP, JavaScript,  and JQuery</li>
                                <li>Experienced with RestFul services and libraries like Picasso and Volley</li>
                                <li>Experienced with Google API, and its services.</li>
                                <li>Experienced with creating Test Units with Junit4 and Expresso.</li>
                                <li>Experienced with Google App Engine, and its web services.</li>
                                <li>Experienced with Frameworks like CodeIgniter, Slim PHP</li>
                                <li>Experienced with into database technologies such as MySQL, SQLite, SQL Server </li>
                                <li>Experienced with libraries for payments such as OpenPay, Mercado Pago, Conekta, Stripe, 2Checkout</li>
                                <li>Familiar with the following design patterns: MVC, MVP, Singleton, Adapter, View Holder.</li>
                                <li>Experienced with implementing persistent data in device memory, web-based databases, and the cloud</li>
                                <li>Comfortable teaching, training, and providing mentoring to fellow developers</li>
                                <li>Enjoys interacting with the end user to gain insight into app usage and determine improvements</li>
                                <li>Self-motivated: and able to stay on task without constant oversight</li>
                                <li>Participated in all phases of the development life cycle including: system analysis, design, development, debugging, report generation, testing and documentation</li>
                                <li>Familiar with Agile approaches, including Extreme Programming, TDD and SCRUM development</li>
                            </ul>
                            <h2 class="heading">More About Me</h2>
         
                            <p>In my free time I like to go out with my friends and meet new people,is always good go to new places and get some fun or exercise. I like the photography and also I love the tattoes even though I don't have any yet.</p>
                            <p><b>"Anyone who has never made a mistake has never tried anything new"</b>-<i>Albert Einstein</i></p>
               ...
               <!--section class="latest section">
                ...
                <section class="experience section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <div class="item">
                                <h3 class="title">Co-Founder & Lead Developer - <span class="place"><a href="#">DevDreamers</a></span> <span class="year">(April 2015 - Present)</span></h3>
                                <p>ShareApp is an application which is in progress</p>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title">Senior Android Developer - <span class="place"><a href="#">Mobile Apps Company</a></span> <span class="year">(August 2015 - Present)</span></h3>
                                <p>Android applications development , Design and web development, Project Management</p>
                            </div><!--//item-->
                            
                            <div class="item">
                                <h3 class="title">Android Developer - <span class="place"><a href="#">APORTAHR OUTSOURCING SA DE CV.</a></span> <span class="year">(2014 - 2015)</span></h3>
                                <p>At AportaHR I have developed an application to connect services from SAP and commit transactions</p>
                            </div><!--//item-->

                            <div class="item">
                                <h3 class="title">Android Developer - <span class="place"><a href="https://parkimovil.com/">PARKIMOVIL</a></span> <span class="year">(2012 - 2014)</span></h3>
                                <p>Parkimovil Project, is a project which is growing up in Mexico, as part of smart cities.</p>
                            </div><!--//item-->
                            
                            <div class="item">
                                <h3 class="title">Android Developer & Web Developer - <span class="place"><a href="https://parkimovil.com/">GEO ENLACE SA DE CV.</a></span> <span class="year">(2012 - 2014)</span></h3>
                                <p>Parkimovil Project, is a project which is growing up in Mexico, as part of smart cities.</p>
                            </div><!--//item-->
            ...
            <div class="secondary col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-envelope-o"></i><span class="sr-only">Email:</span><a href="#">jl.cs606@gmail.com</a></li>
                                <li><i class="fa fa-link"></i><span class="sr-only">Website:</span><a href="#">http://simplek.github.io</a></li>
                            </ul>
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//aside-->
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="skillset">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Android Development<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to add more info...">Expert</span></h3>
                                    <div class="level-bar">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Agile Methodologies<span class="level-label">Pro</span></h3>
                                    <div class="level-bar">
                                ...
                                <!--p><a class="more-link" href="#"><i class="fa fa-external-link"></i> More in Github</a></p--> 
                            </div>              
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//section-->
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="item">
                                ...
                                <h4 class="university">Benemerita Universidad Autonoma de Puebla<span class="year">(2009-2014)</span></h4>
                            </div><!--//item-->
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
                        ...
                        <div class="content">
                            ...
                            <li class="item">
                                ...
                                <li class="item">
                                    ...
                                    <span class="level">Professional Proficiency<br class="visible-xs"/><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-half"></i></i> </span>
                                </li><!--//item-->
                                
                                <li class="item">
                                    <span class="title"><strong>German:</strong></span>
                                    <span class="level">Basic knowledge<br class="visible-sm visible-xs"/><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-half"></i></span>
                                </li><!--//item-->
                            </ul>
                        </div><!--//content-->
                    </div><!--//section-inner-->
                ...
                <aside class="list music aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-headphones"></i> <a href="https://www.youtube.com/watch?v=YBHQbu5rbdQ">Fifth Harmony - Worth it</a></li>
                                <li><i class="fa fa-headphones"></i> <a href="https://www.youtube.com/watch?v=1jre6_FBBc0">Kid Cudi - Pursuit of Happiness (Steve Aoki Remix) </a></li>
                                <li><i class="fa fa-headphones"></i> <a href="https://www.youtube.com/watch?v=SXcFYnHSG08">Locos - León Larregui</a></li>
                            </ul>
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
                ...
                <aside class="education aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">                    
                            <div class="item">
                                <h3 class="title"><i class="fa fa-trophy"></i>Project SHAREAPP</h3>
                                <h4 class="university">WAYRA MEXICO - <span class="year">2015</span></h4>
                            </div><!--//item-->

                            <div class="item">
                                <h3 class="title"><i class="fa fa-trophy"></i>Project SHAREAPP</h3>
                                <h4 class="university">Feria de applicaciones moviles - <span class="year">2015</span></h4>
                            </div><!--//item-->
